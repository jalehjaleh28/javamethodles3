...
function  getEmailDomain(num){

   const len = num.length

  console.log(num.slice( num.indexOf('@') + 1,len))
}
...
function typeOfEmail(email){
    ...
    if(email.indexOf('novi-education')>0){
    
        console.log('student')

    }
    if(email.indexOf('novi.nl')>0){
...
function checkEmailValidity(check){

    if(check.indexOf('@')>0 && check.indexOf(',')<0 && check.lastIndexOf('.', check.length) != check.length){
